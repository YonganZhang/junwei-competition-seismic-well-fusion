...
def _write_audit_report(path: Path, rows: list[dict[str, Any]]) -> None:
    ...
    lines = [
        ...
        f"- foundation gain vs random-init: `{_signed_delta('rmse', _row('strict_development', 'MIC-DKFZ/ResEncL-OpenMind-MAE', 'rmse')['metric_value'], _row('strict_development', 'same_architecture_random_init', 'rmse')['metric_value'])[0]:.12g}`",
        f"- foundation gain vs random-init (%): `{_signed_delta('rmse', _row('strict_development', 'MIC-DKFZ/ResEncL-OpenMind-MAE', 'rmse')['metric_value'], _row('strict_development', 'same_architecture_random_init', 'rmse')['metric_value'])[1]:.12g}`",
