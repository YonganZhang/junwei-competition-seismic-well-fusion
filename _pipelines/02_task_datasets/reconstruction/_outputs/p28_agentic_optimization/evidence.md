...
- A2L promotion RMSE: `0.027761999130990`; relative gain vs A0 `-0.099605%`; fold outcomes `{'win': 0, 'loss': 4, 'tie': 1}`; search AUC `0.001276418`.
...
P19 coordinate purge was applied independently for every held fold. The strategies saw only aggregates from the other four purged folds. Held-fold and final promotion metrics were calculated only after all four actions were fixed and were never fed back to a strategy.
...
| A2L | 3 | 0.027712695506 | 0.027715884040 | +0.011506% | loss |
