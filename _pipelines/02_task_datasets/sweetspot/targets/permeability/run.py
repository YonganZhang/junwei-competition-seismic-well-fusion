"""CLI for sweet-spot target 7 KLOGH permeability."""
...
from p4_pipeline import PERMEABILITY_KLOGH, run_p4_target  # noqa: E402
from task_spec import build_task_spec  # noqa: E402


def main() -> None:
    parser = argparse.ArgumentParser(description="P4 sweet-spot target 7 KLOGH runner")
    ...
    parser.add_argument("--output-dir", type=Path, default=HERE / "_outputs/klogh")
    ...
    result = run_p4_target(
        task_spec=build_task_spec(),
        definition=PERMEABILITY_KLOGH,
