"""P5 thin adapter: SMP DeepLabV3+ with a scratch ResNet18 encoder."""
...
model_id = "smp_deeplabv3plus_r18"
...
def build_model(task_spec: TaskSpec, **config: Any):
    return build_smp_model(model_id, "DeepLabV3Plus", task_spec, **config)
