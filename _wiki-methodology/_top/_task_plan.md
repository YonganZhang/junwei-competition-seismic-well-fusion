...
> 创建: 2026-07-08
> **🧭 当前: [P18 赛道⑥各向异性基础模型地统计获得稳健开发改善，默认仍关闭]**
>   2026-07-31 Claude 独立审查发现 P17 在同一 OOF 上从 156 个候选中选优；
...
| P18 各向异性重建 | ✅ | 1/1 | 嵌套 LOFO top-3 RMSE -2.4501%，5/5 折改善，整折 CI 完全低于零；默认关闭，消融与 holdout 后置。 |
