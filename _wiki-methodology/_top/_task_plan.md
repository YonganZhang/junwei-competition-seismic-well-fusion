...
>   95% 区间仍跨 0。证据见 `_findings/P24_reconstruction_historical_transfer.md`。
...
| P24 历史版本迁移 | ✅ | 1/1 | 冻结 P21 在未使用的同场区历史属性版本上相对 PyKrige RMSE 改善 `1.4529%`、4/5 折获胜；外部盲测仍待完成。 |
...
- [x] 2026-08-01 赛道⑥ P24 完成预注册的同场区历史属性版本迁移测试。冻结 P21 相对重新拟合的
      ...
      开目标后未调参。证据等级不等于 fresh blind/cross-field，最终仍需外部场区或官方隐藏测试。
